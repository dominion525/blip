...
// Tests: Tests/GeometryTests.swift (run with test.sh).
...
enum Geometry {
    ...
    static func spotCenter(mouse: CGPoint, in frame: CGRect) -> CGPoint? {
    ...
    static func framesMatch(windows: [CGRect], screens: [CGRect]) -> Bool {
    ...
    static func holeRect(center: CGPoint, radius: CGFloat) -> CGRect {
