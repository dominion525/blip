...
// Tests: Tests/BlipCoreTests/DoubleTapTests.swift (run with swift test).

import Foundation

public struct DoubleTapTracker {
    ...
    public mutating func update(isDown: Bool, at time: TimeInterval) -> Bool {
